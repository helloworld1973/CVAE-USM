...
import random
from IJCAI_CVAE_USM.train import GPU_CVAE_no_USM_train
import math
...
# /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
file_name = str(DATASET_NAME) + '_' + str(source_user) + '_' + str(target_user) + '_CVAE_no_USM.txt'
file_name_summary = str(DATASET_NAME) + '_' + str(source_user) + '_' + str(
    target_user) + '_CVAE_no_USM_summary.txt'
                            ...
                            for Variance in [1, 2, 0.7, 3, 0.4, 4, 5]:  # 1, 2, 0.7, 3, 0.4, 4, 5
                                for num_sub_act in [5, 10, 15, 20, 25, 30, 35]:
                                    for Num_temporal_states in [num_sub_act,
                                        ...
                                        best_target_acc, best_target_cm, corresponding_best_source_acc, best_epoch = GPU_CVAE_no_USM_train(
                                            S_torch_loader,
                                            T_torch_loader,
                                            ST_torch_loader,
                                            global_epoch=Epochs,
